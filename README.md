...
```bash
git clone https://github.com/yourhandle/advanced-enterprise-email-triage
...
ear-perfect |
| Medium | GPT-4o-mini (0-shot) | 0.54 | Thread context lost |
| Medium | GPT-4o (0-shot) | 0.76 | Good but tool-overuse penalty |
| Hard | GPT-4o-mini (0-shot) | 0.31 | Phishing misses |
| Hard | GPT-4o (0-shot) | 0.58 | BEC still tricky |
| Hard | GPT-4o + CoT prompt | 0.71 | Best baseline |
